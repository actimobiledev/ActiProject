    ...
    private void initListener() {
        ivNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.ID, "");
                userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.NAME, "Karman");
                userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.EMAIL, "karman.singh@actiknowbi.com");
                userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.MOBILE, "9873684678");
                userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.LOGIN_KEY, "asdfgasdfgasdfgasdfgasfg");
                        ...
                        public void onResponse (String response) {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    String message = jsonObj.getString (AppConfigTags.MESSAGE);
                                    if (! error) {
                                        userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.ID, jsonObj.getString (AppConfigTags.USER_ID));
